...
class MyDataset(Dataset):
    def __init__(self, path, normalize_input=None, normalize_output=None):
        ...
        self.label = np.expand_dims(self.label1, 1)
        # self.label = np.expand_dims(self.label, 1)
        self.label = np.transpose(self.label, (0, 1, 3, 2)) # This is to make the shape of data (N, C, Nx, Ny)
